...
class _$_OfferAtIndexParam implements _OfferAtIndexParam {
  ...
  @override
  String toString() {
    return 'OfferAtIndexParam(params: $params, index: $index)';
  }
...
class _$_OfferListings implements _OfferListings {
  ...
  @override
  String toString() {
    return 'OfferListings(asin: $asin, total: $total, cart: $cart, offers: $offers)';
  }
...
class _$_OfferItem implements _OfferItem {
  ...
  @override
  String toString() {
    return 'OfferItem(shopName: $shopName, sellerId: $sellerId, price: $price, condition: $condition, hasImage: $hasImage, isFba: $isFba)';
  }
