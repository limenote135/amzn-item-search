...
final questions = <Faq>[
  ...
  Faq(
    enable: Platform.isIOS,
    title: "バーコードリーダー接続時にキーボードを表示したい",
    bodyText: "iOS では、iOS の仕様により外部バーコードリーダーを接続すると文字入力時にキーボードが表示されなくなります。\n\n"
        "代わりに、多くのバーコードリーダーではスキャンボタンを2回押すとキーボードが表示されるようになっております。\n\n"
        "詳しくはバーコードリーダーの説明書をご確認ください。",
  ),
  const Faq(
  ...
  const Faq(
    title: "問い合わせに対する返答が返ってこない",
    bodyText: "iCloudをご利用の場合などで弊社からのメールが届かないといったお問い合わせをいただくことがございます。\n\n"
        "お問い合わせに対する返答は必ず行っておりますので、以下についてご確認ください。\n\n"
        "・迷惑メールフォルダに入っていないか\n"
        "・メールサービスの容量が上限に達していないか\n",
  ),
];
